package org.aurora.layuiboot.configuration;
...
import org.aurora.layuiboot.filter.KickoutSessionFilter;
import org.aurora.layuiboot.shiro.MyRealm;
...
//        kickoutSessionFilter.setCacheManager(ehCacheManager());
        kickoutSessionFilter.setCache(new MapCache("shiro-activeSessionCache",new HashMap<String, Deque<Serializable>>(64)));
