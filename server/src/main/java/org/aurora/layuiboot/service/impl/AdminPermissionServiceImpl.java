...
public class AdminPermissionServiceImpl implements AdminPermissionService {
    private final Logger logger = LoggerFactory.getLogger(AdminPermissionServiceImpl.class);

    @Resource
    private BaseAdminPermissionDAO permissionDAO;

    @Resource
    private BaseAdminRoleDAO roleDAO;
